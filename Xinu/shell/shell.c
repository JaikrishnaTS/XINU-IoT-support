...
const	struct	cmdent	cmdtab[] = {
    {"obdemo",  FALSE,  xsh_obdemo},
    {"udpsense",FALSE,  xsh_udpsense},
    {"udptrigger",FALSE,  xsh_udptrigger},
	...
	)				/*   to accept commands		*/
{
	...
	fprintf(dev, "\n\n%s%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n",
		...
		SHELL_BAN10,SHELL_BAN11,SHELL_BAN12,SHELL_BAN13,SHELL_BAN14,
		SHELL_BAN15,SHELL_BAN16,SHELL_BAN17,SHELL_BAN18,SHELL_BAN19,
        SHELL_BAN20, SHELL_BAN21);
