...
#define SHELL_BAN9   "\n\n"
#define SHELL_BAN10     "-------------------------------------------------------"
#define SHELL_BAN11     " _________ _______ _________ _        _______  ______  "
#define SHELL_BAN12     " \\__   __/(  ___  )\\__   __/( \\      (  ____ \\(  __  \\ "
#define SHELL_BAN13     "    ) (   | (   ) |   ) (   | (      | (    \\/| (  \\  )"
#define SHELL_BAN14     "    | |   | |   | |   | |   | |      | (__    | |   ) |"
#define SHELL_BAN15     "    | |   | |   | |   | |   | |      |  __)   | |   | |"
#define SHELL_BAN16     "    | |   | |   | |   | |   | |      | (      | |   ) |"
#define SHELL_BAN17     " ___) (___| (___) |   | |   | (____/\\| (____/\\| (__/  )"
#define SHELL_BAN18     " \\_______/(_______)   )_(   (_______/(_______/(______/ "
#define SHELL_BAN19     "                                                       "
#define SHELL_BAN20      "-------------------------------------------------------"
#define	SHELL_BAN21	"\033[0m\n"
